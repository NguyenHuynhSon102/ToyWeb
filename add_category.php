           ...
           if(isset($_POST['txtID'])&& isset($_POST['txtName'])):
                   ...
                   if(isset($_POST['btnAdd']))://add action
                           ...
                           if($execute){ 
                                ...
                                echo "<script> alert('Category ID already existed') </script>".$execute;
                           }
                   else://update action
        ...
        <form id="form1" name="form1" method="post" action="" class="form-horizontal" role="form">
            <div class="form-group pb-3">
                    ...
                    <div class="col-sm-10">
                            ...
                            placeholder="Category ID" value='<?php echo isset($_GET["cid"])?($_GET["cid"]):"";?>'>
                    </div>
            </div>	
            <div class="form-group pb-3">
            ...
            <div class="form-group pb-3">
                <div class="col-sm-offset-2 col-sm-10">
                        <input type="submit"  class="btn btn-primary" name="<?php echo isset($_GET
                        ["cid"])?"btnEdit":"btnAdd"; ?>" id="btnAction" value='<?php echo isset
                        ($_GET["cid"])?"Edit":"Add new"; ?>'/>

                        
                        <input type="button" class="btn btn-primary" name="btnIgnore"  
                        id="btnIgnore" value="Back to list" onclick="window.location.
